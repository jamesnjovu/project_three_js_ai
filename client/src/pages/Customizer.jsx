...
import {CustomButton, FilePicker, ColorPicker, Tab, AIPicker} from '../components'
...
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      const response = await fetch('https://project-threejs-ai-z9rt.onrender.com/api/v1/dalle',{
        method: 'post',
        headers: {
